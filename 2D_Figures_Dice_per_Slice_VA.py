...
# Read in DSC scores
orw_seg1_path = "../Outer Rectal Wall U-Net/Results/CCA_VA/Dice_Per_Slice.xlsx"
lumen_seg1_path = "../Lumen U-Net/Results/CCA_VA/Dice_Per_Slice.xlsx"
fat_seg1_path = "../Fat U-Net/Results/2022-11-23/CCA_VA/Dice_Per_Slice.xlsx"


orw_seg1_dsc = parse_excel(orw_seg1_path)
lumen_seg1_dsc = parse_excel(lumen_seg1_path)
fat_seg1_dsc = parse_excel(fat_seg1_path)

# Get list of patients
subgroup =subgroup.replace("_", " ")
pt_dir = "/Volumes/GoogleDrive/My Drive/tom/Rectal Segmentation/Data-MultipleExperts/VA_Patients/Volumes/"
...
for patient in pt_files:
    ...
    # Get DSC scores
    orw_expert1 = orw_seg1_dsc[patient]
    lumen_expert1 = lumen_seg1_dsc[patient]
    fat_expert1 = fat_seg1_dsc[patient]
    ...
    fig.savefig("2D Figures/Comparisons/VA/" + patient + ".png", dpi = 300, bbox_inches = "tight")
